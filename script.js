  ...
  const fetchProducts = async () => {
    try {
      ...
      const renderCartItem = (product, quantity) => {
        ...
        deleteImage.addEventListener("keydown", (e) => {
            if (e.key === "Enter" || e.key === " ") {
              deleteImage.click(); 
            }
          });
      ...
      searchInput.addEventListener("input", (e) => {
        if (window.getComputedStyle(shopItems).display !== "grid") {
          return; //if the shop container is not being displayed, the input tag shouldn't work
        }
      ...
      detailsBackButton.addEventListener("keydown", (e) => {
        if (e.key === "Enter" || e.key === " ") {
          detailsBackButton.click();//trigger the click function if you press on enter or spacebar
        }
      });
      ...
      cartBackButton.addEventListener("keydown", (e) => {
        if (e.key === "Enter" || e.key === " ") {
      ...
      headerCartIcon.addEventListener("keydown", (e) => {
        if (e.key === "Enter" || e.key === " ") {
